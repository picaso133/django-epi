...
from .models import Resident_manager
from projects.models import Project
from file_storage.models import Files_storage


def index(request, template_name='resident_managers/index.html'):
    list = Resident_manager.objects.filter()
    data = {}
    data['list'] = list
    return render(request, template_name, data)

def create(request, template_name='resident_managers/create.html'):
...
def read(request, pk, template_name='resident_managers/read.html'):
...
def update(request, pk, template_name='resident_managers/create.html'):
...
def delete(request, pk, template_name='resident_managers/delete.html'):
